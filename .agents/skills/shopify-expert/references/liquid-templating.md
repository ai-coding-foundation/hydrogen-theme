...
{{
  ...
  | image_url: width: 800
  | image_tag: srcset: product.featured_image
  | image_url: width: 400
  | append: ' 400w, '
...
{{
  product.featured_image
  | image_url: width: 600
  | image_tag: loading: 'lazy', widths: '200, 400, 600, 800', alt: product.title
}}
...
{% for product in collection.products %}
  {% assign designer = product.metafields.custom.designer.value %}
  {{ designer.name }}
  {%- comment -%} Each iteration queries metaobject {%- endcomment -%}
{% endfor %}
