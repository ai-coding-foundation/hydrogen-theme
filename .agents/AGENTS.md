...
> Cross-platform agent instructions for Cursor, GitHub Copilot, Codex, Claude Code, OpenCode, Windsurf, and any AGENTS.md-compatible tool.
> Managed by [hatch3r](https://github.com/hatch3r/hatch3r). Run `npx hatch3r sync` to regenerate.
